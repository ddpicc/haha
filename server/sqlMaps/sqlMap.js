var sqlMap = {
    ...
    getAllWaitPackage: "SELECT a.*, b.storage_number, b.role FROM littleant_user_package a INNER JOIN littleant_user b ON a.user_id = b.id WHERE a.status != '已处理' order by id desc",
    ...
    existUserPackageByLittleAntTracking: 'select id from littleAnt_user_package where litlleant_tracking_number = ? limit 1',
